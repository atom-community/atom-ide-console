import type { Action, Executor, ConsoleSourceStatus, Record, RecordProvider, SourceInfo, Level } from "../types"
...
export function unregisterRecordProvider(recordProvider: RecordProvider): Action {
...
export function updateStatus(providerId: string, status: ConsoleSourceStatus): Action {
  return {
    type: UPDATE_STATUS,
...
export function setCreatePasteFunction(createPasteFunction: ?CreatePasteFunction): Action {
  return {
...
export function setWatchEditor(watchEditor: ?atom$AutocompleteWatchEditor): Action {
  return {
